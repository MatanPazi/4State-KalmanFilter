...
void loop() {
  ...
  float AngAccY, AngAccYSum = 0, AngAccYMean, AngAccYSumSquare = 0, AngAccYVar;
  int c = 0;
  ...
  while (c < NUM_OF_ITERATIONS) {
    ...
    AngAccY = AccZ - 1 + sin(AccYAng);  //Angular acceleration of sensor
    
    // Calculate the sum of angles for mean value
    AccXAngSum = AccXAngSum + AccXAng;
    AccYAngSum = AccYAngSum + AccYAng;

    // Calculate the sum of the angular acceleration
    AngAccYSum = AngAccYSum + AngAccY;
    c++;
  }
  ...
  AngAccYMean = AngAccYSum / NUM_OF_ITERATIONS;
  ...
  while (c < NUM_OF_ITERATIONS) {
    ...
    // Calculate the Y angular acceleration
    AngAccY = AccZ - 1 + sin(AccYAng);  //Angular acceleration of sensor
    ...
    // Calculate the sum squared of the Y angular acceleration
    AngAccYSumSquare = AngAccYSumSquare + sq(AngAccY - AngAccYMean);
  ...
  AngAccYVar = AngAccYSumSquare / NUM_OF_ITERATIONS;
  ...
  Serial.print("AngAccYVar: ");
  Serial.println(AngAccYVar, 6);
